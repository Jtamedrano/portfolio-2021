      ...
      <Popover className="relative">
        {({ close }) => (
          <>
            <PopoverButton
              className={cx(
                "text-lg hover:text-secondary transition-colors duration-300 inline-flex items-center gap-1 ring-0",
                {
                  "text-secondary underline": pathMane === to,
                }
              )}
            ...
            >
              <div className="w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-slate-800 text-sm/6 shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
                  {flyoutItems.map((item) => (
                    <div
                      key={item.to}
                      className="group relative flex gap-x-6 rounded-lg p-4 hover:bg-slate-700"
                    >
                      <div onClick={close}>
                        <Link
                          href={item.to}
                        ...
                        <p className="text-gray-400 text-sm/5">
                          {item.description}
                        </p>
                      </div>
                    </div>
                ...
                <div className="bg-slate-700 p-4" onClick={close}>
                  <BaseNavItem
