  ...
  return (
    <>
      <PageSectionContainer
        bgClassName="bg-gradient-to-br dark:from-slate-900 from-secondary-700 dark:to-slate-900 to-secondary-900"
        className="py-24"
      >
        <h1 className="text-4xl font-semibold text-center text-secondary-300">
      ...
      <section className="relative isolated bg-gray-300 dark:bg-slate-800 dark:text-slate-100 flex-1 flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 divide-y-2 lg:divide-y-0">
          ...
          <div className="flex items-center justify-center py-24">
            <div>
              <HomePageForm className="dark:bg-slate-700" />
            </div>
          </div>
        </div>
      </section>
      <PageSectionContainer className="flex flex-col py-20 gap-12 lg:flex-row lg:gap-24">
        <div className="flex-1 py-24">
          <h2 className="text-3xl font-semibold dark:text-secondary-400 text-secondary-500">
      ...
      <PageSectionContainer className="py-24 text-center">
        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-2">
          <div className="flex flex-col gap-4 p-8 bg-gray-300 dark:bg-slate-800 rounded-lg shadow-md darkshadow-black/50">
            <h3 className="text-xl font-semibold">
              How much does a website cost?
            </h3>
            <p className="dark:text-gray-300 max-w-lg mx-auto text-lg/8">
          ...
          <div className="flex flex-col gap-4 p-8 bg-gray-300 dark:bg-slate-800 rounded-lg shadow-md dark:shadow-black/50">
            <h3 className="text-xl font-semibold">
